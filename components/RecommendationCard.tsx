    ...
    <View style={styles.card}>
      ...
      {!resolved && rec.actionLabel && (
        <View style={styles.actions}>
          ...
          <PrimaryButton label={`Approve`} variant="dark" onPress={onApprove} style={styles.actionBtn} />
        </View>
      )}
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  divider: { height: 1, backgroundColor: 'rgba(14,18,32,0.08)', marginVertical: 12 },
  ...
  impact: { fontSize: 13.5, color: '#12946B', lineHeight: 19, fontWeight: '600' },
